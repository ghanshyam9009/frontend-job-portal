          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <ul className="hidden lg:flex items-center gap-1">
              <li>
                <button
                  onClick={() => navigate('/')}
                  className={`nav-link-btn px-3 py-2 text-sm font-semibold transition-colors rounded-md ${isActive("/")
                    ? "active text-[#2271B5]"
              ...
              <li>
                <button
                  ...
                  className={`nav-link-btn px-3 py-2 text-sm font-semibold transition-colors rounded-md ${isActive("/recruiter/dashboard")
                    ? "active text-[#2271B5]"
                    : `${textSecondary} hover:text-[#2271B5]`
                    }`}
                >
              ...
              <div className="relative" ref={dropdownRef}>
                <div onClick={handleProfileClick} className="flex flex-col items-center">
                  <button
                    ...
                    className="w-12 h-12 rounded-xl bg-blue-50 text-[#2271B5] flex shadow-md border border-gray-200 items-center justify-center font-bold hover:bg-blue-100 hover:border-[#2271B5] hover:shadow-lg transition-all overflow-hidden"
                  >
                  ...
                  {/* Bold underline below avatar */}
                  <div className="w-12 h-[3px] bg-[#2271B5] mt-1 rounded-full shadow-sm" />
                  <div className="w-12 h-[3px] bg-[#2271B5] mt-1 rounded-full shadow-sm opacity-60" />
                </div>
              </div>
            ...
            >
              <div className="w-6 h-5 flex flex-col justify-between">
                <span
                  className={`block h-0.5 w-full bg-current transform transition-all duration-300 ${isMobileMenuOpen ? 'rotate-45 translate-y-2' : ''
                    }`}
                ></span>
                <span
                  className={`block h-0.5 w-full bg-current transition-all duration-300 ${isMobileMenuOpen ? 'opacity-0' : ''
                    }`}
                ></span>
                <span
                  className={`block h-0.5 w-full bg-current transform transition-all duration-300 ${isMobileMenuOpen ? '-rotate-45 -translate-y-2' : ''
                ...
                <ul className="space-y-1 mb-4 order-3">
                  <li>
                    <button
                      ...
                      className={`w-full flex items-center gap-2 px-3 py-2 rounded-xl border transition-all group ${isActive("/")
                    ...
                    >
                      <div className={`p-2 rounded-lg transition-colors ${isActive("/")
                        ...
                        <Home size={18} className={`transition-colors ${isActive("/")
                  ...
                  <li>
                    <button
                      ...
                      className={`w-full flex items-center gap-2 px-3 py-2 rounded-xl border transition-all group ${isActive("/recruiter/dashboard")
                        ? `border-[#2271B5] ${isDark ? 'bg-[#2271B5]/15' : 'bg-blue-50'} text-[#2271B5]`
                        : `${isDark ? 'border-gray-700 bg-gray-800' : 'border-gray-100 bg-white shadow-sm'} ${textSecondary} hover:border-[#2271B5] hover:bg-blue-50 dark:hover:bg-gray-700 hover:text-[#2271B5]`
                        }`}
                    >
                      <div className={`p-2 rounded-lg transition-colors ${isActive("/recruiter/dashboard")
                        ? (isDark ? 'bg-[#2271B5]/25' : 'bg-blue-100')
                        : (isDark ? 'bg-[#2271B5]/15 group-hover:bg-[#2271B5]/25' : 'bg-blue-50 group-hover:bg-blue-100')
                        }`}>
                        <Hospital size={18} className={`transition-colors ${isActive("/recruiter/dashboard")
                          ? (isDark ? 'text-blue-300' : 'text-[#2271B5]')
                          : (isDark ? 'text-blue-200 group-hover:text-blue-300' : 'text-[#2271B5] group-hover:text-[#1a5a8f]')
                          }`} />
                      </div>
                  ...
                  <li>
                    ...
                    >
                      <div className={`p-2 rounded-lg transition-colors ${isActive("/post-job")
                        ...
                        <Plus size={18} className={`transition-colors ${isActive("/post-job")
                          ? (isDark ? 'text-blue-300' : 'text-[#2271B5]')
                          : (isDark ? 'text-blue-200 group-hover:text-blue-300' : 'text-[#2271B5] group-hover:text-[#1a5a8f]')
                          }`} />
                      </div>
                  ...
                  <li>
                    ...
                    >
                      <div className={`p-2 rounded-lg transition-colors ${isActive("/manage-jobs")
                        ...
                        <FileText size={18} className={`transition-colors ${isActive("/manage-jobs")
                          ? (isDark ? 'text-blue-300' : 'text-[#2271B5]')
                          : (isDark ? 'text-blue-200 group-hover:text-blue-300' : 'text-[#2271B5] group-hover:text-[#1a5a8f]')
                          }`} />
                      </div>
                  ...
                  <li>
                    ...
                    >
                      <div className={`p-2 rounded-lg transition-colors ${isActive("/jobs")
                        ...
                        <Users size={18} className={`transition-colors ${isActive("/jobs")
                          ? (isDark ? 'text-blue-300' : 'text-[#2271B5]')
                          : (isDark ? 'text-blue-200 group-hover:text-blue-300' : 'text-[#2271B5] group-hover:text-[#1a5a8f]')
                          }`} />
                      </div>
                  ...
                  <li>
                    ...
                    >
                      <div className={`p-2 rounded-lg transition-colors ${isActive("/shortlist-candidates")
                        ...
                        <Star size={18} className={`transition-colors ${isActive("/shortlist-candidates")
                          ? (isDark ? 'text-blue-300' : 'text-[#2271B5]')
                          : (isDark ? 'text-blue-200 group-hover:text-blue-300' : 'text-[#2271B5] group-hover:text-[#1a5a8f]')
                          }`} />
                      </div>
                  ...
                  <li>
                    <button
                      onClick={() => { navigate('/company-profile'); closeMobileMenu(); }}
                      className={`w-full flex items-center gap-2 px-3 py-2 rounded-xl border transition-all group ${isActive("/company-profile")
                        ? `border-[#2271B5] ${isDark ? 'bg-[#2271B5]/15' : 'bg-blue-50'} text-[#2271B5]`
                        : `${isDark ? 'border-gray-700 bg-gray-800' : 'border-gray-100 bg-white shadow-sm'} ${textSecondary} hover:border-[#2271B5] hover:bg-blue-50 dark:hover:bg-gray-700 hover:text-[#2271B5]`
                        }`}
                    >
                      <div className={`p-2 rounded-lg transition-colors ${isActive("/company-profile")
                        ? (isDark ? 'bg-[#2271B5]/25' : 'bg-blue-100')
                        : (isDark ? 'bg-[#2271B5]/15 group-hover:bg-[#2271B5]/25' : 'bg-blue-50 group-hover:bg-blue-100')
                        }`}>
                        <Building size={18} className={`transition-colors ${isActive("/company-profile")
                          ? (isDark ? 'text-blue-300' : 'text-[#2271B5]')
                          : (isDark ? 'text-blue-200 group-hover:text-blue-300' : 'text-[#2271B5] group-hover:text-[#1a5a8f]')
                          }`} />
                      </div>
                  ...
                  <li>
                    <button
                      ...
                      className={`w-full flex items-center gap-2 px-3 py-2 rounded-xl border transition-all group ${isActive("/membership-tokens")
                        ? `border-[#2271B5] ${isDark ? 'bg-[#2271B5]/15' : 'bg-blue-50'} text-[#2271B5]`
                        : `${isDark ? 'border-gray-700 bg-gray-800' : 'border-gray-100 bg-white shadow-sm'} ${textSecondary} hover:border-[#2271B5] hover:bg-blue-50 dark:hover:bg-gray-700 hover:text-[#2271B5]`
                        }`}
                    >
                      <div className={`p-2 rounded-lg transition-colors ${isActive("/membership-tokens")
                        ? (isDark ? 'bg-[#2271B5]/25' : 'bg-blue-100')
                        : (isDark ? 'bg-[#2271B5]/15 group-hover:bg-[#2271B5]/25' : 'bg-blue-50 group-hover:bg-blue-100')
                        }`}>
                        <CreditCard size={18} className={`transition-colors ${isActive("/membership-tokens")
                          ? (isDark ? 'text-blue-300' : 'text-[#2271B5]')
                          : (isDark ? 'text-blue-200 group-hover:text-blue-300' : 'text-[#2271B5] group-hover:text-[#1a5a8f]')
                          }`} />
                      </div>
