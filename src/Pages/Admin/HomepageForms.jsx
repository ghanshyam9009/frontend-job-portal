    ...
    return (
      <div className={`min-h-screen ${bgColor} flex items-center justify-center`}>
        <div className="text-center">
          ...
          <h3 className={`text-lg font-bold ${textColor}`}>Loading homepage forms...</h3>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`text-sm ${textSecondary} mt-1`}>
                  Manage demo requests from homepage visitors
                </p>
              </div>
              <button
                onClick={() => window.location.reload()}
            ...
            <div className={`flex items-center justify-between p-5 border-b ${borderColor}`}>
              <div className="flex items-center gap-3">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
                  ...
                  {selectedForm.fullName.charAt(0).toUpperCase()}
                </div>
                <div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className={`${isDark ? 'bg-gray-700/30' : 'bg-gray-50'} rounded-lg p-3 border ${borderColor}`}>
                  ...
                  <p className={`text-sm ${textColor} font-medium`}>{selectedForm.fullName}</p>
                </div>
